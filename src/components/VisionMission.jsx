    ...
    <section id="about" className="py-24 bg-slate-50">
      <div className="container-custom">
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-5xl font-bold mb-4">Our <span className="text-primary">Foundation</span></h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
            className="glass-card p-10 border-t-4 border-t-primary hover:shadow-2xl transition-all duration-300"
          >
          ...
          <motion.div
            ...
            className="glass-card p-10 border-t-4 border-t-secondary hover:shadow-2xl transition-all duration-300"
          >
