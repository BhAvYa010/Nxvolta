        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sectors.map((sector, index) => (
            <motion.div
              ...
              className="glass-card p-8 border border-white/5 transition-all duration-300 group"
            >
              <div className="text-primary mb-6 transition-transform duration-300 group-hover:scale-110 group-hover:text-primary-light">
                {sector.icon}
              </div>
          ...
          <div className="glass-card p-8 border-dashed border-2 border-white/10 flex flex-col items-center justify-center text-center">
            <p className="text-slate-400 mb-4 font-medium text-lg">Your Sector Not Listed?</p>
            <a href="#contact" className="text-primary hover:text-primary-light font-bold flex items-center space-x-2 transition-colors">
